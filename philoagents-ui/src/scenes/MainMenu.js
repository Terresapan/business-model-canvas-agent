...
export class MainMenu extends Scene {
  ...
  createInitialMenu(centerX, startY, buttonSpacing) {
      this.add.text(centerX, startY - 35, "Select Access Mode:", {
          fontSize: "24px",
          fontFamily: "Arial",
          color: "#ffffff",
          stroke: "#000000",
      ...
      this.createButton(centerX - 180, startY + 20, "Admin Access", () => this.handleAdminAccess());
      this.createButton(centerX + 180, startY + 20, "User Access", () => this.handleUserAccess());
  }

  async createAdminDashboard(centerX, startY, buttonSpacing) {
      // Dropdown
      this.dropdown = new Dropdown(this, centerX, startY - 30, 350, 40, [], (index, item) => {
      ...
      this.createButton(centerX + 180, firstLineY, "Instructions", () => this.instructionsPanel.show());
  ...
  createButton(x, y, text, callback) {
    ...
    const hitArea = this.add.rectangle(x, y, buttonWidth, buttonHeight, 0x000000, 0).setInteractive();
