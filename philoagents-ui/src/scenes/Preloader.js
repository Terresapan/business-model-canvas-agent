...
export class Preloader extends Scene {
  ...
  preload() {
    ...
    this.load.atlas(
      "ada_lovelace",
      "characters/ada/atlas.png",
      "characters/ada/atlas.json"
    );
    this.load.atlas(
      "turing",
      "characters/turing/atlas.png",
      "characters/turing/atlas.json"
    );
    this.load.atlas(
      "searle",
      "characters/searle/atlas.png",
      "characters/searle/atlas.json"
    );
    this.load.atlas(
      "chomsky",
      "characters/chomsky/atlas.png",
      "characters/chomsky/atlas.json"
    );
    this.load.atlas(
      "dennett",
      "characters/dennett/atlas.png",
      "characters/dennett/atlas.json"
    );
    this.load.atlas(
      "miguel",
